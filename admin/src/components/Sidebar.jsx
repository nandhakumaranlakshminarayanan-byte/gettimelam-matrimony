    ...
    return (
        <div style={styles.sidebar}>
            ...
            <div style={styles.bottom}>
                ...
                <div style={{ ...styles.menuItem, color: '#FF6B6B' }} onClick={logout}>
                    <span style={styles.menuIcon}>🚪</span>
                    <span>Logout</span>
                </div>
            </div>
...
const styles = {
    ...
    logoText: { fontFamily: "'Georgia', serif", fontSize: '16px', fontWeight: '700', color: '#fff' },
    logoSub: { fontSize: '11px', color: '#C9A84C', letterSpacing: '1px', textTransform: 'uppercase' },
    adminInfo: {
        display: 'flex', alignItems: 'center', gap: '12px',
        padding: '16px 20px',
    ...
    adminRole: { fontSize: '11px', color: '#C9A84C' },
    menu: { flex: 1, padding: '8px 12px' },
    menuItem: {
        display: 'flex', alignItems: 'center', gap: '12px',
    ...
    menuItemActive: { background: 'rgba(201,168,76,0.15)', color: '#C9A84C' },
