    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (activeTab === 'member') {
                ...
                // ✅ Fixed: role is 'service' not 'vendor'
        ...
        <div style={styles.overlay} onClick={(e) => e.target === e.currentTarget && onClose()}>
            <div style={styles.modal}>
                ...
                <div style={styles.tabs}>
                    <div style={{ ...styles.tab, ...(activeTab === 'member' ? styles.tabActive : {}) }}
                        onClick={() => setActiveTab('member')}>
                        I'm Looking for a Match
                    </div>
                    <div style={{ ...styles.tab, ...(activeTab === 'vendor' ? styles.tabActive : {}) }}
                    ...
                    <form onSubmit={handleSubmit}>
                        <div style={styles.grid2}>
                            <div style={styles.formGroup}>
                                ...
                                <select name="profileFor" value={memberForm.profileFor}
                            ...
                            <div style={styles.formGroup}>
                                ...
                                <select name="gender" value={memberForm.gender}
                                    onChange={handleMemberChange} style={styles.input}>
                                    <option>Male</option>
                        ...
                        <div style={styles.grid2}>
                            <div style={styles.formGroup}>
                                ...
                                <input name="dateOfBirth" type="date" value={memberForm.dateOfBirth}
                                    onChange={handleMemberChange} style={styles.input} required />
                            </div>
                            <div style={styles.formGroup}>
                        ...
                        <div style={styles.formGroup}>
                            ...
                            <input name="mobile" type="tel" placeholder="+91 99999 99999"
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={styles.grid2}>
                            <div style={styles.formGroup}>
                                ...
                                <input name="city" type="text" placeholder="e.g. Chennai"
                                    value={vendorForm.city} onChange={handleVendorChange}
                                    style={styles.input} required />
                            </div>
                            <div style={styles.formGroup}>
                                <label style={styles.label}>District *</label>
                                <input name="district" type="text" placeholder="e.g. Coimbatore"
...
const styles = {
    ...
    modal: { background: '#fff', borderRadius: '20px', width: '100%', maxWidth: '520px', maxHeight: '90vh', overflowY: 'auto', padding: '32px 28px' },
    header: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px' },
    title: { fontFamily: "'Playfair Display', serif", fontSize: '26px', color: '#1A0A0A', marginBottom: '4px' },
    subtitle: { fontSize: '14px', color: '#7A6055' },
    closeBtn: { background: '#FDF0F0', border: 'none', width: '36px', height: '36px', borderRadius: '8px', fontSize: '16px', cursor: 'pointer', color: '#8B1A1A' },
    tabs: { display: 'flex', border: '1.5px solid #E8D5C4', borderRadius: '10px', marginBottom: '24px', overflow: 'hidden' },
    tab: { flex: 1, padding: '10px', textAlign: 'center', fontSize: '13px', fontWeight: '500', cursor: 'pointer', color: '#7A6055', background: '#fff', transition: 'all 0.2s ease', userSelect: 'none' },
    tabActive: { background: '#8B1A1A', color: '#fff' },
    vendorNotice: { background: '#FFF8F0', border: '1px solid #E8D5C4', borderRadius: '8px', padding: '12px 14px', fontSize: '13px', color: '#7A6055', marginBottom: '20px', textAlign: 'center', lineHeight: 1.5 },
    ...
    input: { width: '100%', padding: '12px 14px', border: '1.5px solid #E8D5C4', borderRadius: '8px', fontSize: '14px', color: '#2C1810', background: '#FFFDF9', outline: 'none', fontFamily: "'DM Sans', sans-serif", boxSizing: 'border-box' },
    terms: { fontSize: '12px', color: '#7A6055', marginBottom: '16px', lineHeight: 1.6 },
    termsLink: { color: '#8B1A1A', textDecoration: 'underline' },
    submitBtn: { width: '100%', padding: '14px', background: 'linear-gradient(135deg, #8B1A1A, #C0392B)', color: '#fff', border: 'none', borderRadius: '10px', fontSize: '15px', fontWeight: '600', cursor: 'pointer', marginBottom: '16px', fontFamily: "'DM Sans', sans-serif" },
    switchText: { textAlign: 'center', fontSize: '14px', color: '#7A6055' },
    switchLink: { color: '#8B1A1A', fontWeight: '600', cursor: 'pointer' },
};
